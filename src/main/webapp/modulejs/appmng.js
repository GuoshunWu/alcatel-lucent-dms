...
require([
    'jqgrid', 'jqlayout', 'jstree', 'jqmsgbox'
//    'cs!appmng/mycoffee'
], function ($) {
...
//            log(jsonFromServer);
        ...
        .navButtonAdd('#pager', {
            ...
            onClickButton:function () {
                ...
                var gr = $("#applicationGridList").jqGrid('getGridParam', 'selrow');
                if (null == gr) {
                ...
                $("#applicationGridList").jqGrid('delGridRow', gr, {
...
//        alert("to be implemented.");
        //todo: test jqGrid method.
//        $("#applicationGridList").jqGrid('setGridParam', {url:"http://localhost:2000/" + pageStatus.selectedProduct.id, datatype:"json"}).trigger("reloadGrid");
        jQuery("#grid_id").editGridRow(1, {});
