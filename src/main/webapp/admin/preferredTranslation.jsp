<table style="width: 100%;height: 100%" border="0">
    ...
    <tr>
        <td align="center" valign="top">
            <table id="preferredTranslationGrid">
                <tr>
                    <td></td>
                </tr>
            </table>
            <div id="preferredTranslationGridPager"></div>
        </td>
    </tr>
</table>
...
<div id="createPreferredTranslationDialog">
    <table border="0" width="100%">
        <tr>
            <td class="text-align-right"><label for="preferredTranslationReference"><s:text
        ...
        <tr>
            <td colspan="2" align="center">
                <div id="preferredTranslationErrorMsgContainer" style="width: 95%;">
                    <hr/>
                    <span id="errorMsg" style="color: red;">Demo</span>
                </div>
            </td>
        </tr>
    </table>
