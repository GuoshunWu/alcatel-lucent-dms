...
(function (e, t) {
    ...
    jn = Pn.exec(Dn.toLowerCase()) || [], st.fn.load = function (e, n, r) {
        ...
        return u >= 0 && (i = e.slice(u, e.length), e = e.slice(0, u)), st.isFunction(n) ? (r = n, n = t) : n && "object" == typeof n && (o = "POST"), s.length > 0 && st.ajax({url:e, type:o, dataType:"html", data:n}).done(
            function (e) {
