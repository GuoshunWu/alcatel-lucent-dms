...
(function ($) {
    ...
    var PlugIn = {initialized:false, init:function () {
        ...
        $field = $(field);
        var er = {status:false, type:'', message:''};
