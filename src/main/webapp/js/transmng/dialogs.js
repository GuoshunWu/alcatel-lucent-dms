...
(function() {
  define(['jqmsgbox', 'i18n!nls/transmng', 'i18n!nls/common', 'dms-util', 'dms-urls', 'transmng/trans_grid', 'transmng/transdetail_grid', 'transmng/trans_searchtext_grid', 'transmng/trans_matchtext_grid'], function($, i18n, c18n, util, urls, grid, detailgrid, searchgrid, matchgrid) {
    var exportTranslationDialog, handler, languageFilterDialog, ready, refreshGrid, showSearchResult, taskDialog, transDetailDialog, transGrid, transMatchText, transSearchText, transUpdateDialog;
      ...
      buttons: [
        {
          ...
          click: function() {
            ...
            $.post(urls.trans.update_translation, {
              ...
              delete json.message;
              delete json.status;
              return $('#transmngTranslationUpdate').html(showMsg).data('param', json).dialog('open');
            });
            return $(this).dialog('close');
          }
        }, {
