define [
  ...
  grid = $("#transSearchTextGrid").jqGrid(
    ...
    colModel: [
      {name: 'app', index: 'application', width: 100, editable: false, stype: 'select', align: 'left', frozen: true}
      {name: 'dict', index: 'dictionary', width: 100, editable: false, align: 'right', frozen: true, search: false}
