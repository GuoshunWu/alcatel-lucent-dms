...
(function() {
  ...
  dependencies = ['jqgrid', 'jqmsgbox', 'blockui', 'i18n!nls/transmng', 'i18n!nls/common', 'dms-urls', 'dms-util', 'transmng/grid.colmodel'];

  define(dependencies, function($, msgbox, blockui, i18n, c18n, urls, util, gmodel) {
