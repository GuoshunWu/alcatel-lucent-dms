...
(function() {
  ...
  define(['jqgrid', 'util', 'taskmng/dialogs', 'i18n!nls/taskmng', 'i18n!nls/common', 'blockui', 'jqupload', 'iframetransport', 'require'], function($, util, dialogs, i18n, c18n, blockui, jqupload, ifram, require) {
