...
(function() {
  ...
  dependencies = ['jqgrid', 'blockui', 'jqmsgbox', 'jqupload', 'iframetransport', 'i18n!nls/common', 'i18n!nls/taskmng', 'dms-util', 'dms-urls', 'taskmng/dialogs'];

  define(dependencies, function($, blockui, msgbox, upload, iframetrans, c18n, i18n, util, urls, dialogs) {
    var handlers, prop, taskGrid;
    handlers = {
      'Download': {
        title: 'Download',
