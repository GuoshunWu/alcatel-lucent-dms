...
(function() {
  ...
  define(['jqgrid', 'util', 'require', 'taskmng/dialogs', 'i18n!nls/taskmng', 'i18n!nls/common', 'blockui', 'jqmsgbox', 'jqupload', 'iframetransport'], function($, util, require, dialogs, i18n, c18n) {
