...
(function() {
  ...
  dependencies = ['jqueryui', 'jqmsgbox', 'i18n!nls/common', 'i18n!nls/taskmng', 'dms-util', 'taskmng/taskreport_grid', 'taskmng/transdetail_grid'];

  define(dependencies, function($, msgbox, c18n, i18n, util, reportgrid, detailgrid) {
