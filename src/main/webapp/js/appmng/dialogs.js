...
(function() {
  ...
  define(['jqueryui', 'jqmsgbox', 'i18n!nls/common', 'i18n!nls/appmng', 'appmng/dictlistpreview_grid', 'require'], function($, jqmsgbox, c18n, i18n, grid, require) {
    ...
    dictListPreview = $('#dictListPreviewDialog').dialog({
      ...
      open: function() {
        var param;
        param = $(this).data('param');
        return grid.previewUpdate(param);
      }
    });
