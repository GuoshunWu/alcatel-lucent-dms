...
(function() {
  define(['jqueryui', 'jqgrid', 'blockui', 'jqmsgbox', 'i18n!nls/common', 'i18n!nls/appmng', 'dms-urls', 'dms-util', 'appmng/dictlistpreview_grid', 'appmng/stringsettings_grid', 'appmng/dictpreviewstringsettings_grid', 'appmng/previewlangsetting_grid', 'appmng/searchtext_grid'], function($, jqgrid, blockui, msgbox, c18n, i18n, urls, util, previewgrid, stgrid) {
    var addApplication, addLanguage, dictListPreview, dictPreviewLangSettings, dictPreviewStringSettings, historyDlg, langSettings, lockLabels, newAppVersion, newProductVersion, searchResult, setContextTo, showSearchResult, stringSettings, stringSettingsTranslation;
