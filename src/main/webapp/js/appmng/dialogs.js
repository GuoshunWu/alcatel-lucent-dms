...
(function() {
  ...
  define(function(require) {
    var $, addApplication, addLanguage, addNewApplicationVersionToProductVersion, c18n, dictListPreview, dictPreviewLangSettings, dictPreviewStringSettings, historyDlg, i18n, langSettings, newAppVersion, newProductVersion, setContextTo, stringSettings, stringSettingsTranslation, urls, util;
    $ = require('jqueryui');
    require('blockui');
    require('jqmsgbox');
