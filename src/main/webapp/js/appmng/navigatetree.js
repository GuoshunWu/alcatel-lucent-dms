...
(function() {
  ...
  define(['require', 'jqueryui', 'jqtree', 'jqmsgbox', 'i18n!nls/common', 'util', 'appmng/layout', 'appmng/product_panel', 'appmng/application_panel'], function(require, $, tree, msgbox, c18n, util, layout, productpnl, apppnl) {
    var URL, appTree, getNodeInfo, ids, nodeCtxMenu, removeNode, timeFunName, _ref, _ref1, _ref2, _ref3;
    ids = {
    ...
    nodeCtxMenu = {
      products: {
        createproduct: {
          label: 'New product',
          "_disabled": (_ref = util.urlname2Action(URL.product.create), __indexOf.call(param.forbiddenPrivileges, _ref) >= 0),
      ...
      product: {
        createapp: {
          ...
          "_disabled": (_ref1 = util.urlname2Action(URL.app.create), __indexOf.call(param.forbiddenPrivileges, _ref1) >= 0),
          action: function(node) {
            return appTree != null ? appTree.create(node, 'last', {
              data: 'NewApp',
              attr: {
        ...
        del: {
          ...
          "_disabled": (_ref2 = util.urlname2Action(URL.product.del), __indexOf.call(param.forbiddenPrivileges, _ref2) >= 0),
          action: removeNode,
          separator_before: true
        }
      },
      app: {
        del: {
          ...
          "_disabled": (_ref3 = util.urlname2Action(URL.app.del), __indexOf.call(param.forbiddenPrivileges, _ref3) >= 0),
          action: removeNode
        }
      }
    };
