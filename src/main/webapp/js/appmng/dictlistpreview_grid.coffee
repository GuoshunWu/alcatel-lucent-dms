define (require, util, dialogs, i18n)->
  ...
  url: '', datatype: 'json', width: 1000, height: 350
  pager: '#dictListPreviewPager', editurl: "app/create-or-add-application"
  rowNum: 10, rowList: [10, 20, 30]
  postData:{handler:'USER_20121015_165741_263',format:'grid',prop:'languageReferenceCode,base.name,version,base.format,base.encoding,labelNum'}
