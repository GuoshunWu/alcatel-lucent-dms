...
(function() {
  define(['jqgrid', 'blockui', 'jqmsgbox', 'jqueryui', 'i18n!nls/appmng', 'i18n!nls/common', 'dms-util', 'dms-urls', 'appmng/langsetting_grid', 'appmng/stringsettings_grid', 'appmng/history_grid'], function($, blockui, msgbox, ui, i18n, c18n, util, urls) {
    ...
    $('#generateDict').button().width(170).attr('privilegeName', util.urlname2Action(urls.app.generate_dict)).click(function() {
      ...
      return util.updateProgress(urls.app.generate_dict, {
        dicts: dicts.join(','),
        filename: filename
      }, function(json) {
        var dowloadURL;
        ...
        me.button('enable');
        dowloadURL = urls.getURL(urls.app.download_app_dict, '', {
          fileLoc: json.event.msg,
          filename: filename
        });
