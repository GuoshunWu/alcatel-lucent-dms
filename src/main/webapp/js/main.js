...
(function() {
  ...
  define(['jqlayout', 'dms-util', 'globallayout', 'ptree', 'appmng/main', 'transmng/main', 'taskmng/main', 'admin/main'], function($, util, glayout, ptree, appmngPanel, transmngPanel, taskmngPanel, adminPanel) {
