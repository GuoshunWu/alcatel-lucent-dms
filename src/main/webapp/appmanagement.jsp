...
<head>
    ...
    <script type="text/javascript" data-main="modulejs/appmng" src="modulejs/require.js"></script>
...
<div id="optional-container">
    <div class="ui-layout-north" style="text-align: left; bottom:0px">
        <span style="font-family:fantasy; font-size:14pt; font-style:normal; ">Application Management</span>
