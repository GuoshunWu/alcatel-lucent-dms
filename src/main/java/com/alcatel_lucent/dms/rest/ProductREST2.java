...
@Component("productREST2")
@SuppressWarnings("unchecked")
public class ProductREST2 {

    private static Logger log= Logger.getLogger(ProductREST2.class);
    @Context
    UriInfo uriInfo;
    @Context
    Request request;
    ...
    public String retrieveAllProductBase() {
        ...
        String jsonString = jsonService.toTreeJSON2(result, propFilter, propRename).toString();
    ...
    public String retrieveAllProductBaseForTrans(){
        ...
        String jsonString = jsonService.toTreeJSON2(result, propFilter).toString();
        return jsonString;
    }
}
