...
public class ASCTextDictGenerator extends DictionaryGenerator {
    ...
    private void generateProp(File targetDir, Dictionary dict, DictionaryLanguage dl) {
        ...
        if (dl != null) {
            int pos = filename.lastIndexOf("en.txt");
            if (pos != -1) {
                filename = filename.substring(0, pos);
            }
            filename += dl.getLanguageCode() + ".txt";
        }
        ...
        try {
            ...
            out.println("# Generated by DMS at " + FastDateFormat.getDateTimeInstance(FastDateFormat.FULL, FastDateFormat.LONG, Locale.ENGLISH).format(new Date()));
